package com.grimaldo.functional.example._19_final_ops;

import com.grimaldo.functional.example._17_operators_collectors.Operators;
...
public class FinalOperations {
    static void operaciones() {
        ...
        del Stream.
         */
        Stream<List<String>> coursesStream = Operators.getCourses();
        ...
        Stream<List<String>> availableCourses = Operators.getCourses();
        ...
        Stream<List<String>> courses = Operators.getCourses();
